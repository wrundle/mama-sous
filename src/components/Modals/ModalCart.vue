		...
		>
			<div class="sm:h-max sm:min-h-0 min-h-full z-30 -3 relative rounded-lg cursor-default bg-white">
				...
				<div
					...
					class="z-40 p-[10px] sticky bottom-0 flex flex-row justify-between rounded-lg select-none bg-white"
				>
					...
					<div
						@click="addToCart"
						class="
							flex-grow z-50 w-[188px] ml-[15px] text-[18px] leading-[44px] text-center rounded-lg
